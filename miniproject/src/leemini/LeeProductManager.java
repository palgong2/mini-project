...
public class LeeProductManager {
    ...
    public static void manageStock(Map<String, Map<String, List<LeeProduct>>> cosmetics, Scanner scanner) {
        ...
        if (cosmetics.containsKey(type)) {
            ...
            if (subCategories.containsKey(subType)) {
                ...
                LeeProduct selectedProduct = findProductByName(products, productName);
    ...
    public static LeeProduct findProductByName(List<LeeProduct> products, String productName) {
        for (LeeProduct product : products) {
