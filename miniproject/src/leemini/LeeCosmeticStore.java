...
public class LeeCosmeticStore {
    ...
    private static void showProductTypes(Scanner scanner) {
        Map<String, List<LeeProduct>> cosmetics = repository.getCosmetics();
        ...
        if (cosmetics.containsKey(type)) {
            List<LeeProduct> products = cosmetics.get(type);
    ...
    private static LeeProduct findProductByName(List<LeeProduct> products, String productName) {
