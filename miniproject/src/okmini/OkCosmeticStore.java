...
public class OkCosmeticStore {
    ...
    private static void showProductTypes(Scanner scanner) {
        Map<String, Map<String, List<OkProduct>>> cosmetics = repository.getCosmetics();
        ...
        if (cosmetics.containsKey(type)) {
            ...
            if (subCategories.containsKey(subType)) {
                ...
                OkProduct selectedProduct = OkProductManager.findProductByName(products, productName);
    ...
    private static void handleStockManagement(Scanner scanner) {
        ...
        Map<String, Map<String, List<OkProduct>>> cosmetics = repository.getCosmetics();
        OkProductManager.manageStock(cosmetics, scanner);
    }
}
