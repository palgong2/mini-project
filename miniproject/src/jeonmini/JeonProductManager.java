...
public class JeonProductManager {
    ...
    public static void manageStock(Map<String, Map<String, List<JeonProduct>>> cosmetics, Scanner scanner) {
    ...
    public static JeonProduct findProductByName(List<JeonProduct> products, String productName) {
